...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Настройки главной страницы', 'your-textdomain-here' ),
		'id'               => 'basic',
...
require get_template_directory() . '/inc/redux-components/slider.php';



//require_once Redux_Core::$dir . '../sample/sections/basic-fields/slider.php';
...
//require_once Redux_Core::$dir . '../sample/sections/basic-fields/slider.php';
//require_once Redux_Core::$dir . '../sample/sections/basic-fields/multi-slider.php';
